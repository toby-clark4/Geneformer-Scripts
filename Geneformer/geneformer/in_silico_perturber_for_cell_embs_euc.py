...
class InSilicoPerturberEmbsEuc:
    valid_option_dict = {
    ...
    def __init__(
        ...
        sample_cells: None, int
            Number of cells taken from a larger dataset to speed up filtering for perturbations during deletions.
            If None, will include the whole dataset.
